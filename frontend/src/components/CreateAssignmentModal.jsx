  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="w-full max-w-md rounded-2xl border border-slate-700/60 bg-slate-900 p-6 shadow-lg">
        <h2 className="text-lg font-semibold text-slate-100">Create Assignment</h2>

        <form onSubmit={handleSubmit} className="mt-4 space-y-4">
          <div>
            <label htmlFor="assignment-title" className="block text-sm font-medium text-slate-400">
              Title
            </label>
            <input
              id="assignment-title"
          ...
          <div>
            <label htmlFor="assignment-description" className="block text-sm font-medium text-slate-400">
              Description
            </label>
            <textarea
          ...
          <div>
            <label htmlFor="assignment-type" className="block text-sm font-medium text-slate-400">
              Submission Type
            </label>
            <select
              id="assignment-type"
          ...
          <div>
            <label htmlFor="assignment-deadline" className="block text-sm font-medium text-slate-400">
              Deadline
            </label>
            <input
