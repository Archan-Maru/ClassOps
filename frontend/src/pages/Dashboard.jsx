    ...
    <>
      ...
      <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
        <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          {/* â”€â”€ Two-column shell: main + right sidebar â”€â”€ */}
          <div className="flex flex-col gap-8 lg:flex-row lg:items-start">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mb-5 flex items-center justify-between">
                ...
                {!loading && userRole && (
                  <button
                    ...
                    className="rounded-lg bg-violet-600 dark:bg-violet-500 px-4 py-2 text-sm font-semibold text-white transition hover:bg-violet-700 dark:hover:bg-violet-600 active:bg-violet-800"
                  >
              ...
              {!loading && classes.length === 0 && (
                <div className="flex flex-col items-center rounded-2xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 py-20 text-center shadow-[0_1px_3px_rgba(0,0,0,0.05)]">
                  <div className="flex h-14 w-14 items-center justify-center rounded-full bg-violet-50 dark:bg-violet-900/30">
                    <svg
            ...
            {/* â•â• Right sidebar â€“ Upcoming â•â• */}
